...
objects.quests.append(
    Classes.Quest("Find the Ice Key!","self.data == True","The Ice Key")
)
objects.quests.append(
...
objects.quests.append(
    Classes.Quest("Find the Lightning Key!","self.data == True","The Lightning Key")
)
objects.quests.append(
...
objects.quests.append(
    Classes.Quest("Find the Poison Key!","self.data == True","The Poison Key")
)
objects.quests.append(
...
objects.quests.append(
    Classes.Quest("Find the Summoning Key!","self.data == True","The Summoning Key")
)
objects.quests.append(
...
objects.quests.append(
    Classes.Quest("Find the Shield Key!","self.data == True","The Shield Key")
)
objects.quests.append(
...
objects.quests.append(
    Classes.Quest("Find the Laser Key!","self.data == True","The Laser Key")
)
objects.quests.append(
...
objects.quests.append(
    Classes.Quest("Find the Water Key!","self.data == True","The Water Key")
)
objects.quests.append(
...
objects.quests.append(
    Classes.Quest("Defeat the Final Boss!","self.data == True","The Final Boss")
)
